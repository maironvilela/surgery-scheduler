...
// Ícone do Google SVG inline (sem CDN externo — evita riscos de SRI)
function GoogleIcon() {
    return (
...
function LoginContent() {
    ...
    const handleGoogleSignIn = async () => {
        ...
        try {
            ...
            // Erros de rede são tratados pelo NextAuth
            setIsLoading(false);
        }
    };
        ...
        <div className="relative flex min-h-screen items-center justify-center overflow-hidden bg-gradient-to-br from-slate-900 via-blue-950 to-slate-900">
            ...
            <main className="relative z-10 w-full max-w-md px-6">
                ...
                <div className="rounded-2xl border border-white/10 bg-white/5 p-8 shadow-2xl backdrop-blur-xl">
                    ...
                    {error && (
                        <div className="mb-6 rounded-xl border border-red-500/20 bg-red-500/10 px-4 py-3 text-center" role="alert">
                            <p className="text-sm font-medium text-red-400">
                                {error === "AccessDenied"
                                    ? "Acesso não autorizado. Seu e-mail não está na lista de usuários permitidos."
                    ...
                    <button
                        ...
                        disabled={isLoading}
                        className="group flex w-full items-center justify-center gap-3 rounded-xl border border-white/10 bg-white/10 px-4 py-3.5 text-sm font-medium text-white transition-all duration-200 hover:border-white/20 hover:bg-white/15 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-blue-500 focus-visible:ring-offset-2 focus-visible:ring-offset-transparent disabled:cursor-not-allowed disabled:opacity-50"
